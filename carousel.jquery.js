            ...
            return this.each(function () {
                ...
                if (settings.arrows !== false) {
                    ...
                    // Generate the arrows
                        ...
                        state.arrows.next = $('<button class="arrow next"></button>').insertAfter(wrap);
                        state.arrows.previous = $('<button class="arrow previous"></button>').insertAfter(wrap);
                    }
                ...
                if (settings.indicators !== false) {
                    ...
                    self.children().each(function () {
                        indicatorHTML.append($(`<li>${$(this).index()+1}</li>`).click(function () {
