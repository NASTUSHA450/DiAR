...
function SetMenu() {
  if ($("#mobileMenu").hasClass("open-menu")) {
    $("#burger")
      .html(`<svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M22 1L1 22" stroke="white" stroke-width="2"/>
    ...
    $("#burger")
      .html(`<svg width="38" height="22" viewBox="0 0 38 22" fill="none" xmlns="http://www.w3.org/2000/svg">
